...
class CallcenterViewVista extends JViewLegacy
{
        ...
        protected function addToolBar() 
        {
                ...
                JToolBarHelper::title($isNew ?   JText::_('COM_CALLCENTER_MANAGER_VISTA_NEW')
                                             :  JText::_('COM_CALLCENTER-MANAGER_VISTA_EDIT'));
